...
print("evenets.shape", events.shape)  # evenets.shape (319, 3)
...
picks = mne.pick_types(raw.info, meg=False, eeg=True, stim=False, eog=False,
                       exclude='bads')
print("picks=", picks, 'picks.shape=', picks.shape)  # picks.shape= (60,)
...
print("labels=", labels, "label.shape=", labels.shape)

# extract raw data. scale by 1000 due to scaling sensitivity in deep learning
X = epochs.get_data() * 1000  # format is in (trials, channels, samples)
print("X=", X[1], "X.shape=", X.shape)  # X.shape= (288, 60, 151)
y = labels
print("y=", y, "y.shape=", y.shape)  # y.shape= (288,)
...
print(Y_train,Y_train.shape)   #Y_train.shape=(144, 4)
...
print('X_train shape:', X_train.shape)   #X_train shape: (144, 1, 60, 151)
